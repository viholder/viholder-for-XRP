 ...
 <div style="display:flex;" class="contract-menu-conteiner">  
       ...
       <?php if ( isset($pagetitle) && $pagetitle=="market"  ){   ?>
        ...
        <div class="btn-group  float-sm-right  contract-menu" style="width:50%">
            ...
            <?php if (hasPermissions('create_contract')): ?>
                   ...
                   <a  class="btn btn-default"   href="<?php echo base_url()."/market/asking"; ?>"> 
                   <i class="fas fa-arrow-down"></i> </i>  <?php echo lang('App.asking'); ?>  </a>

                 
                   <a  class="btn btn-default" href="<?php echo base_url()."/market/bids"; ?>"> 
                   <i class="fas fa-arrow-up"></i> </i> <?php echo lang('App.bids'); ?>  </a>
                   
         
                  <a  class="btn btn-default" href="<?php echo base_url()."/market/order_book"; ?>"> 
                  <i class="fas fa-book"></i> <?php echo lang('App.order_book'); ?>  </a>
             <?php endif; ?>     
