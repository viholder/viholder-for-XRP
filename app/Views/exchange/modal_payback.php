...
<div class="modal fade" id="modal-payback">
       ...
       <!-- ////////////////////////////////////// -->  
            ...
            <div class="modal-body" style="padding:0px">
                 ...
                 <div style="display:flex;width:100%">
                     ...
                     <div id="btn_payback" class="btn btn-block btn-success" style="width:50%;padding-top:20px;"> <?php echo lang('App.request_widthdrawal') ?>  </div>
...
$(document).on('click', '.btn_payback', function(){ 

  
        accountID= $(this).data('id'); 
    
        $("#amount").val("");
        $('#modal-payback .modal-title').html('<?php echo  lang('App.funds_withdrawal'); ?> '); 
        $('#modal-payback .modal-body #texto-dialog').html('<?php echo lang('App.open_position_modal_text'); ?> '); 
        $('#modal-payback').modal('show'); 
  });



  $(document).on('click', '#btn_request_payback', function(){ 
