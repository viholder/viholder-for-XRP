...
<div class="modal fade" id="modal-wallet">
            ...
            <div class="modal-header" style="background:#efefef;border: 0px;">
              ...
              <div style="display:flex;width:100%;margin-top: 5px;">
                                ...
                                <div class="form-group" style="width:100%">
                                        <label for="wallet_selector" style="width:100%;marign-bottom:10px;"><?php echo lang('App.select_wallet_to_send_from_and_wallet_to_receipt') ?>
                                            <div class="input-group input-group-lg" style="width:100%;margin-top:10px;">
                                                      <div class="input-group-prepend">
                                                        <span class="input-group-text">
                                                              <?php echo lang('App.from'); ?></span>
                                                        </span>
                                                      </div>
...
$(document).on('click', '.btn_wallet', function(){ 

        accountID= $(this).data('id'); 
    
        $("#amount").val("");
        $('#modal-wallet .modal-title').html('<?php echo  lang('App.funds_withdrawal'); ?> '); 
        $('#modal-wallet .modal-body #texto-dialog').html('<?php echo lang('App.open_position_modal_text'); ?> '); 
