...
<!-- /.card -->
        ...
        <div class="card">
              <div class="card-header">
                <h3 class="card-title"><?php echo lang('App.visibility'); ?> </h3>
                </div>
                 <div class="card-body p-0">
                   <div class="form-group nav-link">
                       <label>  </label>
                      
                       <select class="select2" id="listausers" name="visibility_by[]"   multiple="multiple" style="width:100%">
                            <option value="anonimo"><b><?php echo lang('App.all_users'); ?></b></option>
                      </select>
                  </div>
                </div>
...
load_users();
      function load_users(){  
          ...
          $.ajax({
              url: "<?php  echo url("users/get_users");?>",
              type: "POST",
              cache: false,
              "data": data,  
