      ...
      <div class="card card-secondary card-tabs" style="margin-bottom:0px;margin-top:0px">
          <div class="card-header p-0 pt-1">
            <ul class="nav nav-tabs" id="custom-tabs-five-tab" role="tablist">
              <li class="nav-item">
                <a class="nav-link active" id="sale-tabs-five-overlay-tab" data-toggle="pill" href="#sale-tabs-five-overlay" role="tab" aria-controls="custom-tabs-five-overlay" aria-selected="true"><?php echo lang('App.order'); ?></a>
              </li>
...
$(document).on('click', '.btn_manage_poistion', function(){ 
  ...
  function update_order(position_ID){  
      ...
      var data= { "<?= csrf_token() ?>" : "<?= csrf_hash() ?>" , "action":"update_order", "position_ID" : position_ID , "saleprice" : saleprice, "units" : units_to_sale, "market_price" : market_price, "type":type, "fragmented":fragmented };
      $.ajax({
          url: "<?php  echo url("portfolio/update_order");?>",
          type: "POST",
          cache: false,
          "data": data,  
